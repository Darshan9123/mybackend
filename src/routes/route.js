...
const vvv = require('../validator/formatter.js')
...
//  Problem - 2
    console.log(ddd.PrintDate());
    console.log(ddd.PrintMonth());
    console.log(ddd.getBatchInfo());

//  Problem - 3
    console.log(vvv.TrimData());
    console.log(vvv.Lowercase());
    console.log(vvv.Uppercase());
